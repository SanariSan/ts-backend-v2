...
class NoDataError extends ResponseError {
	...
	constructor(ERROR_MESAGE, ERROR_DESCRIPTION = "") {
		...
		super(ERROR.INTERNAL.RESPONSE.NO_DATA.NAME, ERROR_DESCRIPTION);
...
class NoResponseError extends ResponseError {
	...
	constructor(ERROR_MESAGE, ERROR_DESCRIPTION = "") {
		...
		super(ERROR.INTERNAL.RESPONSE.NO_RESPONSE.NAME, ERROR_DESCRIPTION);
		this.ERROR_MESAGE = ERROR_MESAGE;
	}
}
...
class NoResultError extends ResponseError {
	...
	constructor(ERROR_MESAGE, ERROR_DESCRIPTION = "") {
		...
		super(ERROR.INTERNAL.RESPONSE.NO_RESULT.NAME, ERROR_DESCRIPTION);
		this.ERROR_MESAGE = ERROR_MESAGE;
	}
}
...
class BadStatusError extends ResponseError {
	...
	constructor(ERROR_MESAGE, ERROR_DESCRIPTION = "") {
		...
		super(ERROR.INTERNAL.RESPONSE.BAD_STATUS.NAME, ERROR_DESCRIPTION);
		this.ERROR_MESAGE = ERROR_MESAGE;
	}
}
